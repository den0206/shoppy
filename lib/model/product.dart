  ...
  Future<void> uploadToFireStore() async {
    ...
    for (final newImage in newImages) {
      if (images.contains(newImage)) {
        uploadImages.add(newImages as String);
      } else {
        final uuid = Uuid().v1();
        final path = "$id/$uuid";
...
List<Product> sampleProducts = [
  ...
  Product(
      ...
      brand: Brand.all,
      category: KCategory.beauty_health,
      quantity: 8515,
      isPopular: false),
  Product(
